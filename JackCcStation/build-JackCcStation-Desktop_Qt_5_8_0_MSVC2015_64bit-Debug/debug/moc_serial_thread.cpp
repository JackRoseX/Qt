...
#include "../../JackCcStation/serial_thread.h"
...
QT_MOC_LITERAL(1, 14, 11), // "recv_signal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 9), // "sendATIOk"
QT_MOC_LITERAL(4, 37, 15), // "signal_send_att"
QT_MOC_LITERAL(5, 53, 13) // "slot_senddata"

    },
    "Serial_Thread\0recv_signal\0\0sendATIOk\0"
    "signal_send_att\0slot_senddata"
};
...
void Serial_Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recv_signal((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->sendATIOk((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 2: _t->signal_send_att((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        case 3: _t->slot_senddata((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Serial_Thread::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Serial_Thread::recv_signal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Serial_Thread::*_t)(float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Serial_Thread::sendATIOk)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Serial_Thread::*_t)(float , float , float );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Serial_Thread::signal_send_att)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Serial_Thread::recv_signal(QByteArray _t1)
{
...
// SIGNAL 1
void Serial_Thread::sendATIOk(float _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Serial_Thread::signal_send_att(float _t1, float _t2, float _t3)
{
